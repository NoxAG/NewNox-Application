...
public class TextFinding extends Finding {
    ...
    public enum TextFindingType {
        WORDING, SENTENCE_COMPLEXITY, REPETITIV_WORDING, PAGINATION, BIBLIOGRAPHY, POSITIVE_BIBLIOGRAPHY, TABLE_OF_CONTENT, LIST_OF_ABBREVIATIONS, TABLE_OF_FIGURES, FONT_SIZE, FONT_TYPE;
    }
}
